# Aurora PostgreSQL Database Users
...
# with access to the Aurora cluster
...
resource "aws_secretsmanager_secret" "api_user" {
  ...
  name                    = "${var.project}-${var.environment}-aurora-api-user"
  description             = "Credentials for Aurora PostgreSQL API user"
...
resource "aws_secretsmanager_secret" "migrate_user" {
  ...
  name                    = "${var.project}-${var.environment}-aurora-migrate-user"
  description             = "Credentials for Aurora PostgreSQL migration user"
  recovery_window_in_days = var.secret_recovery_window_days
